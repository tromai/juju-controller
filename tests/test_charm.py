...
from charm import AgentConfError, JujuControllerCharm
...
class TestCharm(unittest.TestCase):
    ...
    def test_apiaddresses_missing(self, _):
        ...
        with self.assertRaisesRegex(AgentConfError, "agent.conf key 'apiaddresses' missing"):
    ...
    def test_apiaddresses_not_list(self, _):
        ...
        with self.assertRaisesRegex(AgentConfError, "agent.conf key 'apiaddresses' is not a list"):
            harness.charm.api_port()
