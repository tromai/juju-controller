...
"""Client for the Juju control socket."""
...
class ControlSocketClient(unixsocket.SocketClient):
    ...
    def set_workload_tracing_config(
        ...
        tail_sampling_threshold: str | None = None,
        ...
        if tail_sampling_threshold is not None:
            body['tail_sampling_threshold'] = tail_sampling_threshold
